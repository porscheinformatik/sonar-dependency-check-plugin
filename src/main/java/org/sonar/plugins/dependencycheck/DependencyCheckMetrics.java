...
public final class DependencyCheckMetrics implements Metrics
{
    ...
    public static final Metric DEPENDENCY = new Metric.Builder(DEPENDENCY_CHECK_UNLISTED_KEY, "Dependency Check", Metric.ValueType.DATA)
        .setDescription("unlisted Dependencies")
